...
function Input(props) {
    ...
    return (
        <div className={`input-wrapper position-relative ${props.className ? props.className : ''}`} style={props.div_style}>
            <input 
                ...
                {...attr} />
            <label
                className={`input-label text-start ${props.labelClass ? props.labelClass : ''}`}
